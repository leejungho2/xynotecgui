...
{
    public class EmbossEffectConfigToken
        : AngleChooserConfigToken
    {
        ...
        {
            return new EmbossEffectConfigToken(this);
        }

        public EmbossEffectConfigToken(double angle)
            : base(angle)
        {
        }

        protected EmbossEffectConfigToken(EmbossEffectConfigToken copyMe)
            : base(copyMe)
        {
        }
    }
